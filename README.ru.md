...
| Команда | Что делает |
|---|---|
| `make build` | `Scripts/bundle.sh`: swift build, сборка `build/Cyclop.app`, ad-hoc подпись |
...
Сборка из исходников подписана ad-hoc и не нотаризована. На маке, где её
собрали, она открывается сразу; на любом другом первый запуск идёт через
